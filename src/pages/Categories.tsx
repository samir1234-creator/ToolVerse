...
import { Calculator, Ruler, Code2, Type, Landmark, HeartPulse } from 'lucide-react';
...
export default function Categories() {
  ...
  return (
    <motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit">
      <PageHeader title="Categories" subtitle="Browse tools by focused category bundles" />
      <motion.div variants={staggerContainer} initial="initial" animate="animate" className="grid grid-cols-2 gap-3 px-4 pb-28 pt-5">
        {categoryIds.map((id) => {
          ...
          const Icon = icons[id] || Calculator;
          ...
          return (
            <motion.button
              ...
              className="flex flex-col items-start gap-3 rounded-3xl bg-[var(--color-surface)] p-5 text-left shadow-sm border border-[var(--color-line)]"
            >
